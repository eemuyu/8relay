...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagALL_RELAY_ON)
    {
        info->event[info->num] = EVENT_ALL_RELAY_ON;
        info->num++;
        dataPoints->valueALL_RELAY_ON = gizStandardDecompressionValue(ALL_RELAY_ON_BYTEOFFSET,ALL_RELAY_ON_BITOFFSET,ALL_RELAY_ON_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_1_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_1_ONOFF;
        info->num++;
        dataPoints->valueRELAY_1_ONOFF = gizStandardDecompressionValue(RELAY_1_ONOFF_BYTEOFFSET,RELAY_1_ONOFF_BITOFFSET,RELAY_1_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_2_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_2_ONOFF;
        info->num++;
        dataPoints->valueRELAY_2_ONOFF = gizStandardDecompressionValue(RELAY_2_ONOFF_BYTEOFFSET,RELAY_2_ONOFF_BITOFFSET,RELAY_2_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_3_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_3_ONOFF;
        info->num++;
        dataPoints->valueRELAY_3_ONOFF = gizStandardDecompressionValue(RELAY_3_ONOFF_BYTEOFFSET,RELAY_3_ONOFF_BITOFFSET,RELAY_3_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_4_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_4_ONOFF;
        info->num++;
        dataPoints->valueRELAY_4_ONOFF = gizStandardDecompressionValue(RELAY_4_ONOFF_BYTEOFFSET,RELAY_4_ONOFF_BITOFFSET,RELAY_4_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_5_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_5_ONOFF;
        info->num++;
        dataPoints->valueRELAY_5_ONOFF = gizStandardDecompressionValue(RELAY_5_ONOFF_BYTEOFFSET,RELAY_5_ONOFF_BITOFFSET,RELAY_5_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_6_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_6_ONOFF;
        info->num++;
        dataPoints->valueRELAY_6_ONOFF = gizStandardDecompressionValue(RELAY_6_ONOFF_BYTEOFFSET,RELAY_6_ONOFF_BITOFFSET,RELAY_6_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_7_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_7_ONOFF;
        info->num++;
        dataPoints->valueRELAY_7_ONOFF = gizStandardDecompressionValue(RELAY_7_ONOFF_BYTEOFFSET,RELAY_7_ONOFF_BITOFFSET,RELAY_7_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagRELAY_8_ONOFF)
    {
        info->event[info->num] = EVENT_RELAY_8_ONOFF;
        info->num++;
        dataPoints->valueRELAY_8_ONOFF = gizStandardDecompressionValue(RELAY_8_ONOFF_BYTEOFFSET,RELAY_8_ONOFF_BITOFFSET,RELAY_8_ONOFF_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueALL_RELAY_ON != cur->valueALL_RELAY_ON)
    {
        GIZWITS_LOG("valueALL_RELAY_ON Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_1_ONOFF != cur->valueRELAY_1_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_1_ONOFF Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_2_ONOFF != cur->valueRELAY_2_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_2_ONOFF Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_3_ONOFF != cur->valueRELAY_3_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_3_ONOFF Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_4_ONOFF != cur->valueRELAY_4_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_4_ONOFF Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_5_ONOFF != cur->valueRELAY_5_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_5_ONOFF Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_6_ONOFF != cur->valueRELAY_6_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_6_ONOFF Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_7_ONOFF != cur->valueRELAY_7_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_7_ONOFF Changed\n");
        ret = 1;
    }
    if(last->valueRELAY_8_ONOFF != cur->valueRELAY_8_ONOFF)
    {
        GIZWITS_LOG("valueRELAY_8_ONOFF Changed\n");
        ret = 1;
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    gizStandardCompressValue(ALL_RELAY_ON_BYTEOFFSET,ALL_RELAY_ON_BITOFFSET,ALL_RELAY_ON_LEN,(uint8_t *)devStatusPtr,dataPoints->valueALL_RELAY_ON);
    gizStandardCompressValue(RELAY_1_ONOFF_BYTEOFFSET,RELAY_1_ONOFF_BITOFFSET,RELAY_1_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_1_ONOFF);
    gizStandardCompressValue(RELAY_2_ONOFF_BYTEOFFSET,RELAY_2_ONOFF_BITOFFSET,RELAY_2_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_2_ONOFF);
    gizStandardCompressValue(RELAY_3_ONOFF_BYTEOFFSET,RELAY_3_ONOFF_BITOFFSET,RELAY_3_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_3_ONOFF);
    gizStandardCompressValue(RELAY_4_ONOFF_BYTEOFFSET,RELAY_4_ONOFF_BITOFFSET,RELAY_4_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_4_ONOFF);
    gizStandardCompressValue(RELAY_5_ONOFF_BYTEOFFSET,RELAY_5_ONOFF_BITOFFSET,RELAY_5_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_5_ONOFF);
    gizStandardCompressValue(RELAY_6_ONOFF_BYTEOFFSET,RELAY_6_ONOFF_BITOFFSET,RELAY_6_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_6_ONOFF);
    gizStandardCompressValue(RELAY_7_ONOFF_BYTEOFFSET,RELAY_7_ONOFF_BITOFFSET,RELAY_7_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_7_ONOFF);
    gizStandardCompressValue(RELAY_8_ONOFF_BYTEOFFSET,RELAY_8_ONOFF_BITOFFSET,RELAY_8_ONOFF_LEN,(uint8_t *)devStatusPtr,dataPoints->valueRELAY_8_ONOFF);
