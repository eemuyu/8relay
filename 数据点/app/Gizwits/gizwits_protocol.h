...
* @{
*/
#define PRODUCT_KEY "389b0062adcb42d685ea08c93a8d3204"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "7411004674b54c559cc2ae55f2ac5c11"
...
* @{
*/
#define ALL_RELAY_ON_BYTEOFFSET                    0
#define ALL_RELAY_ON_BITOFFSET                     0
#define ALL_RELAY_ON_LEN                           1
#define RELAY_1_ONOFF_BYTEOFFSET                    0
#define RELAY_1_ONOFF_BITOFFSET                     1
#define RELAY_1_ONOFF_LEN                           1
#define RELAY_2_ONOFF_BYTEOFFSET                    0
#define RELAY_2_ONOFF_BITOFFSET                     2
#define RELAY_2_ONOFF_LEN                           1
#define RELAY_3_ONOFF_BYTEOFFSET                    0
#define RELAY_3_ONOFF_BITOFFSET                     3
#define RELAY_3_ONOFF_LEN                           1
#define RELAY_4_ONOFF_BYTEOFFSET                    0
#define RELAY_4_ONOFF_BITOFFSET                     4
#define RELAY_4_ONOFF_LEN                           1
#define RELAY_5_ONOFF_BYTEOFFSET                    0
#define RELAY_5_ONOFF_BITOFFSET                     5
#define RELAY_5_ONOFF_LEN                           1
#define RELAY_6_ONOFF_BYTEOFFSET                    0
#define RELAY_6_ONOFF_BITOFFSET                     6
#define RELAY_6_ONOFF_LEN                           1
#define RELAY_7_ONOFF_BYTEOFFSET                    0
#define RELAY_7_ONOFF_BITOFFSET                     7
#define RELAY_7_ONOFF_LEN                           1
#define RELAY_8_ONOFF_BYTEOFFSET                    1
#define RELAY_8_ONOFF_BITOFFSET                     8
#define RELAY_8_ONOFF_LEN                           1
...
typedef struct {
    bool valueALL_RELAY_ON;
    bool valueRELAY_1_ONOFF;
    bool valueRELAY_2_ONOFF;
    bool valueRELAY_3_ONOFF;
    bool valueRELAY_4_ONOFF;
    bool valueRELAY_5_ONOFF;
    bool valueRELAY_6_ONOFF;
    bool valueRELAY_7_ONOFF;
    bool valueRELAY_8_ONOFF;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
    uint8_t flagALL_RELAY_ON:1;
    uint8_t flagRELAY_1_ONOFF:1;
    uint8_t flagRELAY_2_ONOFF:1;
    uint8_t flagRELAY_3_ONOFF:1;
    uint8_t flagRELAY_4_ONOFF:1;
    uint8_t flagRELAY_5_ONOFF:1;
    uint8_t flagRELAY_6_ONOFF:1;
    uint8_t flagRELAY_7_ONOFF:1;
    uint8_t flagRELAY_8_ONOFF:1;
} attrFlags_t;
